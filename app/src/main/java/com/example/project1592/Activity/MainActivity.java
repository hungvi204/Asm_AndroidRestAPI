package com.example.project1592.Activity;
...
import com.example.project1592.Adapter.BestDealAdapter;
import com.example.project1592.Adapter.CategoryAdapter;
import com.example.project1592.Model.CategoryDomain;
import com.example.project1592.Model.ItemsDomain;
import com.example.project1592.R;
...
//        items.add(new ItemsDomain("pineapple", "Fresh Pineapple", 10, "Transport yourself to the tropics with the exotic taste of pineapple. Juicy and tantalizingly sweet, this golden fruit is not only a treat for your taste buds but also a rich source of vitamins and enzymes, promoting digestive health and adding a splash of sunshine to your day.", 3));
//        items.add(new ItemsDomain("strawberry", "Fresh Strawberry", 12, "Delight in the sweetness of strawberries, each berry a burst of flavor and nutrition. Whether enjoyed on their own or added to your favorite dishes, these red gems are a guilt-free pleasure, offering a dose of vitamin C, antioxidants, and a touch of natural sweetness.", 4));
        return items;
    }
}